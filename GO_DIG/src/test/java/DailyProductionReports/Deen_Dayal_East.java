    ...
    private static void interactWithApplication() {
        try {
    		...
    		System.out.println("selecting field from the Field Dropdown");
    		 ...
    		 WebElement ele3 = driver.findElement(By.name("Deen Dayal East"));
             ele3.click();
         ...
         Thread.sleep(5000);
          ...
          //Handle the table to send data
        	...
        	act4.sendKeys("9").build().perform();act4.sendKeys("5").build().perform();act4.sendKeys("4").build().perform();act4.sendKeys("0").build().perform();
        	...
        	act4.sendKeys("1").build().perform();act4.sendKeys("0").build().perform();act4.sendKeys("5").build().perform();
        	act1.sendKeys("7").build().perform();
        	act1.sendKeys("0").build().perform();
        	act4.sendKeys(".").build().perform();
        	act4.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	...
        	act4.sendKeys("8").build().perform();act4.sendKeys("5").build().perform();act4.sendKeys("4").build().perform();act4.sendKeys(".").build().perform();
        	act4.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	act4.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	...
        	act7.sendKeys("8").build().perform();act7.sendKeys(".").build().perform();
        	act7.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	act7.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	
        	act7.moveByOffset(95, 0).click().perform();
        	act7.sendKeys("1").build().perform();act4.sendKeys("5").build().perform();act1.sendKeys(".").build().perform();
        	act7.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	act7.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	...
        	act8.sendKeys("9").build().perform();act7.sendKeys(".").build().perform();
        	act8.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	act8.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	
        	act8.moveByOffset(95, 0).click().perform();
        	act8.sendKeys("1").build().perform();act1.sendKeys("6").build().perform();act8.sendKeys(".").build().perform(); 
        	act8.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	act8.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	...
        	act8.sendKeys("7").build().perform();act7.sendKeys("3").build().perform();act1.sendKeys(".").build().perform();
        	act8.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	act8.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
