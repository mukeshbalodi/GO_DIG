    ...
    private static void interactWithApplication() {
        try {
    		...
    		System.out.println("selecting field from the Field Dropdown");
    		 ...
    		 WebElement ele3 = driver.findElement(By.name("Cambay"));
             ele3.click();
          ...
          //Handle the table to send data
        	...
        	act2.sendKeys(".").build().perform();
         	act2.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
          	...
          	act2.sendKeys("1").build().perform();act2.sendKeys(".").build().perform();act2.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
          	act2.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	...
        	act3.sendKeys("6").build().perform();act3.sendKeys("3").build().perform();
        	...
        	act3.sendKeys("5").build().perform();act3.sendKeys("4").build().perform();
        	act3.sendKeys(".").build().perform();
        	act3.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	act3.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	...
        	act3.sendKeys("1").build().perform();act3.sendKeys("9").build().perform();act3.sendKeys("3").build().perform();act3.sendKeys(".").build().perform();
        	act3.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	act3.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	
        	act3.moveByOffset(98,0).click().perform();
        	act3.sendKeys("1").build().perform();act3.sendKeys(".").build().perform();
        	act3.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	act3.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	...
        	act4.sendKeys("5").build().perform();act4.sendKeys("4").build().perform();act4.sendKeys("0").build().perform();act4.sendKeys(".").build().perform();
        	act4.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	act4.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	
        	act4.moveByOffset(95,0).click().perform();
        	act4.sendKeys("5").build().perform();act4.sendKeys("0").build().perform();act4.sendKeys(".").build().perform();
        	act4.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	act4.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	
        	
        	act4.moveByOffset(96,0).click().perform();
        	act4.sendKeys("6").build().perform();act4.sendKeys("0").build().perform();act4.sendKeys(".").build().perform();
        	act4.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	act4.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	
        	act4.moveByOffset(97,0).click().perform();
        	act4.sendKeys("1").build().perform();act4.sendKeys("3").build().perform();act4.sendKeys("9").build().perform();act4.sendKeys("8").build().perform();act4.sendKeys(".").build().perform();
        	act4.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	act4.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
