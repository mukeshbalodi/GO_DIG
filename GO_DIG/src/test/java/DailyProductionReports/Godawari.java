    ...
    private static void interactWithApplication() {
        try {
    		...
    		System.out.println("selecting field from the Field Dropdown");
    		 ...
    		 WebElement ele3 = driver.findElement(By.name("Godavari"));
             ele3.click();
         ...
         Thread.sleep(5000);
          ...
          //Handle the table to send data
        	...
        	act3.sendKeys("4").build().perform();
        	act2.sendKeys("2").build().perform();
        	act3.sendKeys(".").build().perform();
        	act3.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	act3.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	...
        	act4.sendKeys("3").build().perform();act4.sendKeys("0").build().perform();act4.sendKeys("6").build().perform();act4.sendKeys("8").build().perform();
        	act4.sendKeys("9").build().perform();
        	...
        	act4.sendKeys("3").build().perform();act4.sendKeys("8").build().perform();act4.sendKeys("5").build().perform();act4.sendKeys("2").build().perform();
        	act4.sendKeys(".").build().perform();
        	act4.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	act4.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	...
        	act4.sendKeys("4").build().perform();act4.sendKeys("9").build().perform();act4.sendKeys("8").build().perform();act4.sendKeys(".").build().perform();
        	act4.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	act4.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	
        	act4.moveByOffset(97,0).click().perform();
        	act4.sendKeys("3").build().perform();act4.sendKeys("8").build().perform();act4.sendKeys("6").build().perform();act4.sendKeys("2").build().perform();
        	act4.sendKeys(".").build().perform();
        	act4.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	act4.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	
        	act4.moveByOffset(98,0).click().perform();
        	act4.sendKeys("0").build().perform();act4.sendKeys(".").build().perform();
        	act4.sendKeys("0").build().perform();
        	...
        	act7.sendKeys("3").build().perform();act7.sendKeys("8").build().perform();act4.sendKeys(".").build().perform();
        	act7.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	act7.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	
        	act7.moveByOffset(96, 0).click().perform();
        	act7.sendKeys("0").build().perform();act7.sendKeys(".").build().perform();act7.sendKeys("0").build().perform();
        	act7.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	
        	act7.moveByOffset(97, 0).click().perform();
        	act7.sendKeys("4").build().perform();act7.sendKeys(".").build().perform();
        	act7.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	act7.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	...
        	act8.sendKeys("4").build().perform();act8.sendKeys("2").build().perform(); act8.sendKeys(".").build().perform();
        	act8.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	act8.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	...
        	act8.sendKeys("4").build().perform();act8.sendKeys(".").build().perform();
        	act8.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
        	act8.sendKeys(Integer.toString(generateRandomNumber())).build().perform();
